...
const pairToObj = (pair: [string, any]) => ({ name: pair[0], ...pair[1] });
// @ts-ignore
const objToPropArray = R.pipe(R.toPairs, R.map(pairToObj));

const createCompany = (props: any) => ({ ...companyDefault, ...props });
const createUser = (props: any) => ({ ...userDefault, ...props });
const createGroup = (props: any) => ({ ...groupDefault, ...props });
const createComputer = (props: any) => ({ ...computerDefault, ...props });
const createDomain = (props: any) => ({ ...domainDefault, ...props });
const createProduct = (props: any) => ({ ...productDefault, ...props });
const createConnection = (props: any) => ({ ...connectionDefault, ...props });
const createSyncronization = (props: any) => ({
