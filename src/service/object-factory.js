...
const createSyncronization = props => ({...syncronizationDefault, ...props});
...
const userDefault = {
    ...
    physicalDeliveryOfficeName: {category: "General", friendlyName: "Office", value: ""},
    telephoneNumber: {category: "General", friendlyName: "Telephone Number", value: ""},
    otherTelephone: {category: "General", friendlyName: "Telephone Number (Other)", value: ""},
    ...
    postalCode: {category: "Address", friendlyName: "Zip/Postal Code", value: ""},
    c: {category: "Address", friendlyName: "Country Name", value: ""},
    memberOf: {category: "Group", friendlyName: "Group", value: ""},
    userPrincipalName: {category: "Account", friendlyName: "User Logon Name", value: ""},
    sAMAccountName: {category: "Account", friendlyName: "User Logon Name (Pre W2K)", value: ""},
    homePhone: {category: "Telephones", friendlyName: "Home", value: ""},
    otherHomePhone: {category: "Telephones", friendlyName: "Home (Other)", value: ""},
    pager: {category: "Telephones", friendlyName: "Pager", value: ""},
    otherPager: {category: "Telephones", friendlyName: "Pager (Other)", value: ""},
    mobile: {category: "Telephones", friendlyName: "Mobile", value: ""},
    otherMobile: {category: "Telephones", friendlyName: "Mobile (Other)", value: ""},
    facsimileTelephoneNumber: {category: "Telephones", friendlyName: "Fax", value: ""},
    otherFacsimile: {category: "Telephones", friendlyName: "Fax (Other)", value: ""},
    ...
    otherIpPhone: {category: "Telephones", friendlyName: "IP Phone (Other)", value: ""},
    info: {category: "Telephones", friendlyName: "Notes", value: ""},
    title: {category: "Organization", friendlyName: "Title", value: ""},
    department: {category: "Organization", friendlyName: "Department", value: ""},
    company: {category: "Organization", friendlyName: "Company", value: ""},
    manager: {category: "Organization", friendlyName: "Manager", value: ""},
    employeeID: {category: "Organization", friendlyName: "Employee ID", value: ""},
    employeeType: {category: "Organization", friendlyName: "Employee Type", value: ""},
    employeeNumber: {category: "Organization", friendlyName: "Employee Number", value: ""},
    carLicense: {category: "Organization", friendlyName: "Car License", value: ""},
    division: {category: "Organization", friendlyName: "Division", value: ""},
    roomNumber: {category: "Organization", friendlyName: "Room Number", value: ""},
    mailNickname: {category: "Exchange", friendlyName: "Alias", value: ""},
    displayNamePrintable: {category: "Exchange", friendlyName: "Simple Display Name", value: ""},
    proxyAddresses: {category: "Exchange", friendlyName: "Email addresses", value: []},
    extensionAttribute1: {category: "Exchange Attributes", friendlyName: "extensionAttribute1", value: ""},
    extensionAttribute2: {category: "Exchange Attributes", friendlyName: "extensionAttribute2", value: ""},
    extensionAttribute3: {category: "Exchange Attributes", friendlyName: "extensionAttribute3", value: ""},
    extensionAttribute4: {category: "Exchange Attributes", friendlyName: "extensionAttribute4", value: ""},
    extensionAttribute5: {category: "Exchange Attributes", friendlyName: "extensionAttribute5", value: ""},
    extensionAttribute6: {category: "Exchange Attributes", friendlyName: "extensionAttribute6", value: ""},
    extensionAttribute7: {category: "Exchange Attributes", friendlyName: "extensionAttribute7", value: ""},
    extensionAttribute8: {category: "Exchange Attributes", friendlyName: "extensionAttribute8", value: ""},
    extensionAttribute9: {category: "Exchange Attributes", friendlyName: "extensionAttribute9", value: ""},
    extensionAttribute10: {category: "Exchange Attributes", friendlyName: "extensionAttribute10", value: ""},
    extensionAttribute11: {category: "Exchange Attributes", friendlyName: "extensionAttribute11", value: ""},
    extensionAttribute12: {category: "Exchange Attributes", friendlyName: "extensionAttribute12", value: ""},
    extensionAttribute13: {category: "Exchange Attributes", friendlyName: "extensionAttribute13", value: ""},
};
...
const groupDefault = {
    ...
    objectSid: {category:"General", friendlyName: "ObjectSid", value: ""},
    sAMAccountName: {category:"General", friendlyName: "sAMAccountName", value: ""},
};
