...
routerProvisioning.post(
  ...
  async (req, res) => {
    ...
    const provisioning: any = await provisioningService.getData(
      req.params.id,
      data.id
    );
    ...
    run(
      res,
      () => provisioningService.setData(data, req.params.id, data.id),
      undefined,
      undefined,
      data
    );
...
routerProvisioning.put(
  ...
  (req, res) => {
    ...
    run(res, () =>
      provisioningService.updateData(
        data,
        req.params.id,
...
routerProvisioning.delete(
  ...
  (req, res) => {
    const data = {};
    run(res, () =>
      provisioningService.deleteData(
        data,
        req.params.id,
        req.params.provisioningId
      )
