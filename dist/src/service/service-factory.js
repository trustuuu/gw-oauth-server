...
import { getDoc, geChildtDoc, getCollectionCount, setDoc, addDoc, updateDoc, deleteDoc, } from "../firebase/firebase-service.js";
export const createService = (pathFn) => {
    return {
        ...
        deleteDataByPath: (dataPath) => deleteDoc(dataPath, undefined),
    };
};
